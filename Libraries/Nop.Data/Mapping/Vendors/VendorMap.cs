...
namespace Nop.Data.Mapping.Vendors
{
    ...
    public partial class VendorMap : NopEntityTypeConfiguration<Vendor>
    {
        ...
        public override void Configure(EntityTypeBuilder<Vendor> builder)
        {
            ...
            builder.Property(vendor => vendor.ShopName).HasMaxLength(400);
            ...
            builder.Property(vendor => vendor.FollowersNumber);
            ...
            builder.Property(vendor => vendor.KnownFor).HasMaxLength(100);
